...
const I18N = {
  en: {
    ...
    vary_fuel: "Fuel price on x", vary_kwh: "Electricity price on x",
    sweetspot_hint: "Below the line charging wins, above it fuel wins. The dot is where you are.",
    chart_title_fuel: "Break-even: fuel price (x) vs. electricity price (y)",
    chart_title_kwh: "Break-even: electricity price (x) vs. fuel price (y)",
    ...
    axis_per_liter: "Price (CHF / liter)", axis_per_kwh: "Price (CHF / kWh)",
  ...
  de: {
    ...
    vary_fuel: "Benzinpreis auf x", vary_kwh: "Strompreis auf x",
    sweetspot_hint: "Unter der Linie lohnt sich Laden, darüber Benzin. Der Punkt bist du.",
    chart_title_fuel: "Break-even: Benzinpreis (x) vs. Strompreis (y)",
    chart_title_kwh: "Break-even: Strompreis (x) vs. Benzinpreis (y)",
    ...
    axis_per_liter: "Preis (CHF / Liter)", axis_per_kwh: "Preis (CHF / kWh)",
